...
document.getElementById("loginbutton").addEventListener("click", signInWithEmailPassword());
document.getElementById("regbutton").addEventListener("click", signUpWithEmailPassword());